...
export default function UnifiedSettings({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-30 flex items-center justify-center">
      <div className="bg-gray-800 text-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        {/* BPM Settings */}
        <div className="mb-4">
          <h3 className="text-lg font-semibold mb-2">Speed (BPM)</h3>
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-sm font-medium">{settings.bpm} BPM</span>
            </div>
